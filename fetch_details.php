...
$sql = "select pol.id as politician_id,pol.email as email,det.id as det_id,det.*,par.id as party_id,par.party_name,cat.id as cat_id,cat.category_name,c.city_name from politicians as pol\n"
